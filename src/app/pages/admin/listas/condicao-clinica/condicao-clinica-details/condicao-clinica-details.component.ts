...
export class CondicaoClinicaDetailsComponent implements OnInit {
  ...
  @Input() condicaoClinicaForm: UntypedFormGroup;
  ...
  createCondicaoClinicaoForm(){
    this.condicaoClinicaForm = this._formBuilder.group({
      lstConCliDescricao: new UntypedFormControl(''),
      lstConCliCategoria: new UntypedFormControl(''),
      lstConCliPalavraChave: new UntypedFormControl(''),
    });
  }
